...
<head>
	...
	<title>Online Courses - EduCore</title>
	<link rel="stylesheet" type="text/css" href="onlinecourses.css">
...
<body>
	...
	<header id="header">
		<nav>
			<div class="logo">
				<a href="index.php">
					<img src="images/icon/brand.png" alt="logo">
				</a>
			</div>
			<ul>
			
				<li><a href="\EduCore\index.php">Home</a></li>
				<li><a href="#java">Java</a></li>
				<li><a href="#c++">C++</a></li>
				<li><a href="#python">Python</a></li>
				<li><a href="#data">Data Structures</a></li>
				<li><a href="#algo">Algorithm</li>
				<li><a href="#html_css">HTML and CSS</li>
...
<!-- MAIN Heading of Page -->
	<div class="title">
		<span>Online Courses on EduCore</span>
		<div class="shortdesc">
			<p>Online courses offer flexible learning, allows us to acquire new skills and knowledge</p>
		</div>
	</div>
...
<br><br>
	...
	<footer>
        <h2>Contact Us</h2><br>
        <p align="justify">If you have any questions or need assistance, feel free to reach out:</p>
        <p><img src="images/icon/telephone.png"><span> +91-33-4602XXX</span><br><img src="images/icon/email.png"><span>&nbsp;
